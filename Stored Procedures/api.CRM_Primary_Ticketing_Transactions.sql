...
DECLARE @totalCount         INT,
	 ...
	 --  ,@SSB_CRMSYSTEM_ACCT_ID VARCHAR(50) = 'Test',
		...
		--@PageNumber   INT = 0
	/*
DECLARE @SSB_CRMSYSTEM_CONTACT_ID VARCHAR(50) = 'D0C04E50-3F79-4E0C-B639-E478CD84F87B'
EXEC  [api].[CRM_Primary_Ticketing_Transactions] @SSB_CRMSYSTEM_CONTACT_ID = 'D0C04E50-3F79-4E0C-B639-E478CD84F87B'
...
WHERE DimSeason.SeasonYear >= (YEAR(GETDATE()) - 3)
	  AND SeasonClass IS NOT NULL
      --AND fts.BlockPurchasePrice > 0
ORDER BY DimSeason.SeasonYear DESC, Season_Name DESC
