...
CREATE  PROC [rpt].[Basketball_HOB_1] (@SeasonYear INT, @YTD BIT)
AS

--DECLARE @SeasonYear INT = 2018
--DECLARE @YTD BIT = 1

--EXEC rpt.Basketball_HOB_1 @SeasonYear, 0
--EXEC rpt.Basketball_HOB_1 @SeasonYear, 1
...
VALUES
 ...
 ('Top'		, 'Student Season'			,'Student Season'								,0			,0)
,('Top'		, 'Single Game Tickets'		,'Single Game Tickets'							,0			,0)
,('Top'		, 'Mini Plans'				,'Mini Plans'									,0			,0)
,('Top'		, 'Season Sales'			,'Season Sales'									,4500000	,4445000) --20180614 jbarberio added in "Budget_Rev" Value
