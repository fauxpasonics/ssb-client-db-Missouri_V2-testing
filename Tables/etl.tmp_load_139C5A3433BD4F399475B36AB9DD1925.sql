CREATE TABLE [etl].[tmp_load_139C5A3433BD4F399475B36AB9DD1925]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_139C5A3433BD4F399475B36AB9DD1925_ss] ON [etl].[tmp_load_139C5A3433BD4F399475B36AB9DD1925] ([SourceSystem], [SSID])
GO
