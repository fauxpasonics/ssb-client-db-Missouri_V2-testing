...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF_DimArena_CreateDate] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF_DimArena_UpdateDate] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF_DimArena_DeleteFlag] DEFAULT ((0)),
