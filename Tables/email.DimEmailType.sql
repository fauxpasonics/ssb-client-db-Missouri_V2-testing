...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Creat__12CD8B92] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Updat__13C1AFCB] DEFAULT (getdate()),
