...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceAcct__Creat__1BF4A114] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceAcct__Updat__1CE8C54D] DEFAULT (getdate()),
