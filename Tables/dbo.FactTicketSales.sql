...
GO
CREATE NONCLUSTERED INDEX [FactTicketSales_DimCustomerId] ON [dbo].[FactTicketSales] ([DimCustomerId]) INCLUDE ([BlockPurchasePrice], [DimCustomerIdSalesRep], [DimDateId], [DimEventId], [DimItemId], [DimPriceCodeId], [DimSeasonId], [DimSeatIdStart], [DimTicketTypeId], [OwedAmount], [PaidAmount], [QtySeat])
GO
CREATE NONCLUSTERED INDEX [IX_UpdatedDate] ON [dbo].[FactTicketSales] ([UpdatedDate] DESC)
GO
