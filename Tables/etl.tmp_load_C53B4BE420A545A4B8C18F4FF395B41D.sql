CREATE TABLE [etl].[tmp_load_C53B4BE420A545A4B8C18F4FF395B41D]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_C53B4BE420A545A4B8C18F4FF395B41D_ss] ON [etl].[tmp_load_C53B4BE420A545A4B8C18F4FF395B41D] ([SourceSystem], [SSID])
GO
