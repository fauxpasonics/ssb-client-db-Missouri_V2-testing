CREATE TABLE [etl].[tmp_load_E8D215DA4DB54AEC98C8C1865BBAD618]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_E8D215DA4DB54AEC98C8C1865BBAD618_ss] ON [etl].[tmp_load_E8D215DA4DB54AEC98C8C1865BBAD618] ([SourceSystem], [SSID])
GO
