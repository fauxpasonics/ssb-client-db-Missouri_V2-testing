CREATE TABLE [segmentation].[SegmentationFlatData07801baa-8fe7-46a2-9630-2b645333a3ae]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData07801baa-8fe7-46a2-9630-2b645333a3ae] ADD CONSTRAINT [pk_SegmentationFlatData07801baa-8fe7-46a2-9630-2b645333a3ae] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData07801baa-8fe7-46a2-9630-2b645333a3ae] ON [segmentation].[SegmentationFlatData07801baa-8fe7-46a2-9630-2b645333a3ae] ([_rn])
GO
