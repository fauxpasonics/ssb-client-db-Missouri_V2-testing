CREATE TABLE [segmentation].[SegmentationFlatData576a70ae-d7d5-4578-b9c4-4e58604f4126]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData576a70ae-d7d5-4578-b9c4-4e58604f4126] ADD CONSTRAINT [pk_SegmentationFlatData576a70ae-d7d5-4578-b9c4-4e58604f4126] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData576a70ae-d7d5-4578-b9c4-4e58604f4126] ON [segmentation].[SegmentationFlatData576a70ae-d7d5-4578-b9c4-4e58604f4126] ([_rn])
GO
