CREATE TABLE [etl].[tmp_load_3B1AF9A19AD84BF4A861536024FF6E5C]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_3B1AF9A19AD84BF4A861536024FF6E5C_ss] ON [etl].[tmp_load_3B1AF9A19AD84BF4A861536024FF6E5C] ([SourceSystem], [SSID])
GO
