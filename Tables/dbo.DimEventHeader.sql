...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF_DimEventHeader_CreateDate] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF_DimEventHeader_UpdateDate] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF_DimEventHeader_DeleteFlag] DEFAULT ((0)),
