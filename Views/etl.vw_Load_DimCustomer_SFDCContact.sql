...
*/
		...
		SELECT
			...
			/*AddressPrimary*/
			, MailingStreet [AddressPrimaryStreet]
			, MailingCity [AddressPrimaryCity] 
			, MailingState [AddressPrimaryState] 
			, MailingPostalCode [AddressPrimaryZip] 
			, NULL AS [AddressPrimaryCounty]
			, [MailingCountry] [AddressPrimaryCountry] 
			...
			, CASE WHEN p.SSB_CRMSYSTEM_SSID_Winner__c IS NULL OR p.SSB_CRMSYSTEM_SSID_Winner_SourceSystem__c IS NULL THEN NULL
			   WHEN p.SSB_CRMSYSTEM_SSID_Winner_SourceSystem__c = 'TM' THEN 'TM-' + p.SSB_CRMSYSTEM_SSID_Winner__c
...
--select count(*)
		...
		OR p.SSB_CRMSystem_SSIDWinnerSourceSystem__c != p.SSB_CRMSYSTEM_SSID_Winner_SourceSystem__c
