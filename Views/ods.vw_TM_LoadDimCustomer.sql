...
--base set
		SELECT 
			...
			/*AddressPrimary*/
            , CASE  WHEN NULLIF(street_addr_1,'') IS NULL THEN NULL
			...
			, NULLIF(city,'') AS [AddressPrimaryCity] 
			, NULLIF(state,'')	AS [AddressPrimaryState] 
			, NULLIF(zip,'')	AS [AddressPrimaryZip] 
			, NULL AS [AddressPrimaryCounty]
			, NULLIF(country,'')	AS [AddressPrimaryCountry] 
			...
			/*Email*/
			, NULLIF(email_addr	,'')	AS [EmailPrimary]
			, NULLIF(email_addr2,'')	AS [EmailOne]
			, NULL AS [EmailTwo]
